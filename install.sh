...
#install packages
sudo pacman -S xorg-server xorg-xinit i3-wm lightdm lightdm-gtk-greeter rofi rofi-calc rofi-emoji picom polybar i3blocks i3lock i3status alacritty dmenu pavucontrol fish xdg-user-dirs feh playerctl dunst
